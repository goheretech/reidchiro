...
<div class="bg-gray-100 px-20 pb-20 flex">
	<div class="w-1/3 ">
		<div class="bg-white w-full h-full p-6 rounded-lg shadow-lg">
			<div class="bg-cover bg-center w-full h-full" style="background-image:url(img/int/_OSR6163.jpg); height:400px;"></div>
		</div>
	</div>
	<div class="w-2/3 pl-24 flex justify-center flex-col">
		<h2 class="font-bold text-5xl text-main">
			Meet Dr. Reid
		</h2>
